function startIdentification(){
    ...
    classifier=ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/qf0_TEY0x/model.json", model_ready); 
...
function gotResults(error, results){
    ...
    if(error){
        ...
        document.getElementById("result_sound").style.color="rgb("+color_r+","+color_g+","+color_b+")";
